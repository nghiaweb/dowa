...
class createBarChart {
    ...
    draw(data) {
        ...
        this._Bar.append('g')
            ...
            // .attr('height', (d) => this._height - 115 - this._yScale(d))
        this._Bar.append('g')
            ...
            .attr('y', (d) => {
                ...
                return this._yScale(d) + (this._height - 115 - this._yScale(d))/2 + 15
            })
            .text((d)=>{return d;})
    ...
    pathTween() {
        this._Bar.selectAll('rect')
            .transition()
            .attrTween('height', (d) => {
                var i = d3.interpolate(0, this._height - 115 - this._yScale(d));
                return (t)=>{
                    return i(t);
                };
            })
            .attrTween('y', (d) => {
                var i = d3.interpolate(this._height - 115, this._yScale(d));
                return (t)=>{
                    return i(t);
                };
            })
            .duration(1500)
            // .end();
        this._Bar.selectAll('.group-img image')
            .transition()
            .duration(1000)
            .delay(800)
            .style('opacity', 1)
            .attr('transform', 'translate(0, 0)')
        this._Bar.selectAll('.group-text text')
            .transition()
            .duration(1000)
            .delay(800)
            .style('opacity', 1)
...
diagram7.add_text('../../images/voice/voice1/img_text_chart2.png', 89, 315);
// diagram7.pathTween();


let callFuction = ['diagram1.pathTween()', 'diagram2.pathTween()', 'diagram3.pathTween()', 'diagram4.pathTween()', 'diagram6.pathTween()', 'diagram7.pathTween()'];

$.each($('.draw-chart'), function(index) {
